...
const VideoSection = () => {
  return (
    <Container mt="xl" size="xl" mb="xl" fluid>
      ...
      >
        <ScrollArea h={"100%"} miw={"100%"} type="scroll" offsetScrollbars>
          <Tabs.List>
            <Tabs.Tab value="gallery">
              <VideoCard
                image="https://i.ibb.co/YLYZF0T/Screenshot-2.png"
                title="Семья мастеров изделий из бетона и гипса"
                subTitle="Видео Телеканал Беларусь 24"
              />
            </Tabs.Tab>
            <Tabs.Tab value="messages">
              <VideoCard
                image="https://i.ibb.co/TPBTSNw/Screenshot-1.png"
                title="Наше утро с 54 минуты"
                subTitle="Видео OHT"
              />
            </Tabs.Tab>
